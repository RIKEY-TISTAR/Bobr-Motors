    ...
    @foreach ($footers as $footer) 
        <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1">
            ...
            <div class="Text col-span-1">
                ...
                <p class="sub w-[70%] title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-4">{{ $footer['graphic'] }}</p>
                <p class="sub w-[70%] title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-2">{{ $footer['graphic-two'] }}</p>
            </div>
            ...
            <div class="Text col-span-1">
                ...
                <div class="footer-soc flex gap-2 items-center mt-4">
                    <p class="sub title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light">{{ $footer['phone'] }}</p>
                    <img class="w-[25px] h-[25px]" src="{{ url('storage', $footer['soc-images']) }}" alt="Фото соцсети">
                </div>

                <div class="footer-soc flex gap-2 items-center mt-2">
                    <p class="sub title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light">{{ $footer['phone-two'] }}</p>
                    <img class="w-[25px] h-[25px]" src="{{ url('storage', $footer['soc-images-2']) }}" alt="Фото соцсети">
                </div>
            </div>

            <div class="Text col-span-1">
                <p class="sub title text-gray-400 lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-8">Адрес:</p>
                <p class="sub title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-4">{{ $footer['adress'] }}</p>
            </div>
