                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="w-full h-full]">
                                ...
                                <div class="decs sm:pl-0">
                                    <p class="pt-8 xl:text-4xl lg:text-2xl md:text-xl sm:text-2xl text-xl font-bold text-white dark:black"> <?php echo e($product->price); ?> руб</p>  
                                </div>
                            </div>
...
</main> <?php /**PATH D:\APP\Laravel\autoService-2025\resources\views/livewire/single-product.blade.php ENDPATH**/ ?>