    <div class="container mx-auto mt-12 sm:grid grid-cols-10 gap-6 p-6">

        <div class="w-full xl:col-span-2 col-span-3 bg-[#232B33] h-full sm:h-[500px] p-6 mb-6"> 
            ...
            <div class="w-full md:mt-4 mt-2 mb-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <label wire:key="<?php echo e($category->id); ?>" for="<?php echo e($category->slug); ?>">
                                <input class="accent-sky-600 chk" wire:model.live="selected_categories" type="checkbox" id="<?php echo e($category->slug); ?>" value="<?php echo e($category->id); ?>">
                                <span class=" text-gray-700 dark:text-gray-400 lg:text-xl md:text-lg sm:text-lg text-base font-light" ><?php echo e($category->name); ?></span>
                            </label>
                        </div>
                ...
                <div class="mb-2">
                    ...
                    <div>
                        <label for="<?php echo e($brand->slug); ?>">
                            <input class="accent-sky-600" wire:model.live="selected_brands" type="checkbox" id="<?php echo e($brand->slug); ?>" value="<?php echo e($brand->id); ?>">
                            <span class=" text-gray-700 dark:text-gray-400 lg:text-xl md:text-lg sm:text-lg text-base font-light"><?php echo e($brand->name); ?></span>
                        </label>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
                ...
                <div class="mb-2">
                    <div class="text-white lg:text-xl md:text-xl sm:text-lg text-base font-medium">Популярный товар:</div>
...
<?php endif; ?>
    ...
    </div><?php /**PATH D:\APP\Laravel\autoService-2025-1.6\resources\views/livewire/page-products.blade.php ENDPATH**/ ?>