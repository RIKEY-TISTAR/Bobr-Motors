...
<div class="max-w-lg bg-[#232B33] w-full h-full">
    ...
    <div class="flex justify-center items-center p-6">
        <img class="h-[300px] w-full" src="<?php echo e(url('storage', $product->images[0])); ?>" alt="">
    </div>
    <div class="px-6 w-full">
        <div class="h-[70px]">
            ...
            <p class="xl:text-lg lg:text-lg md:text-xl sm:text-2xl text-xl font-normal text-white mb-4">Категория: <?php echo e($product->category->name); ?></p>
        </div>

        <p class="xl:text-lg lg:text-lg md:text-xl sm:text-2xl text-xl font-normal text-white">Краткое описание:</p>

        <div class="h-[90px]">
            <p class="xl:text-lg lg:text-lg md:text-xl sm:text-2xl text-xl font-normal text-gray-700 dark:text-gray-400"><?php echo e($product['sub-title']); ?></p>
    
            <p class="xl:text-lg lg:text-lg md:text-xl sm:text-2xl text-xl font-normal text-gray-700 dark:text-gray-400"><?php echo e($product['sub-title-two']); ?></p>

            <p class="xl:text-lg lg:text-lg md:text-xl sm:text-2xl text-xl font-normal text-gray-700 dark:text-gray-400"><?php echo e($product['sub-title-thre']); ?></p>
        </div>
...
</div><?php /**PATH D:\APP\Laravel\autoService-2025-1.5\resources\views/components/product/product-card.blade.php ENDPATH**/ ?>