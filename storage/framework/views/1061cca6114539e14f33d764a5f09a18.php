<footer class="Contact relative bg-[#232B33] py-10 mt-20 px-10 container mx-auto">
    ...
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $footers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        ...
        <div class="Text col-span-1">
            ...
            <p class="sub w-[70%] title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-8"><?php echo e($footer['graphic']); ?></p>
        ...
        <div class="Text col-span-1">
            ...
            <div class="footer-soc flex gap-2 items-center mt-8">
        ...
        <div class="Text col-span-1">
            ...
            <p class="sub title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light mt-8"><?php echo e($footer['adress']); ?></p>
        </div>
    ...
    <p class="sub title text-white lg:text-2xl md:text-xl  sm:text-lg  text-base font-light">Copyright © 2022 - 2025 Название компании</p>

</footer><?php /**PATH D:\APP\Laravel Project\autoService-2025\resources\views/livewire/partials/footer.blade.php ENDPATH**/ ?>