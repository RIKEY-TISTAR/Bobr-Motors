<main>     
    ...
    <div class="container mx-auto">      
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $callings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calling): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <section class="Contact xl:px-16 px-6 relative bg-[#232B33] py-10 mt-12 grid lg:grid-cols-2 md:grid-cols-1">
...
</main> <?php /**PATH D:\APP\Laravel\autoService-2025-1.5\resources\views/livewire/page-home.blade.php ENDPATH**/ ?>