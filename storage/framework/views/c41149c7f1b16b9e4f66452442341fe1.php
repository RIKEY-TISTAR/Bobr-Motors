                ...
                <div class="mb-2">
                    ...
                    <div>
                        <label for="<?php echo e($brand->slug); ?>">
                            ...
                            <span class=" text-gray-700 dark:text-gray-400 lg:text-xl md:text-lg sm:text-lg text-base font-light"><?php echo e($brand->speciality); ?></span>
                        </label>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                </div>
...
<?php endif; ?>
    ...
    </div><?php /**PATH D:\APP\Laravel\autoService-2025-1.9-full\resources\views/livewire/page-products.blade.php ENDPATH**/ ?>